...
class pharmacy():
    def __init__(self, root):
        ...
        title = tk.Label(self.root, text="Pharmacy Management System", bd=4, relief="groove",
                         font=("Arial", 50, "bold"), bg=self.clr(240, 150, 200))
        ...
        addBtn = tk.Button(addFrame, command=self.insertFun, text="Add Medicine", bd=2, relief="raised",
        ...
        optFrame.place(width=self.width / 3 - 200, height=self.height - 180, x=self.width / 3 + self.width / 2 - 40,
                       y=100)

        srchBtn = tk.Button(optFrame, command=self.searchFun, text="Search", width=10, font=("Arial", 20, "bold"),
                            bg="gray")
        srchBtn.grid(row=0, column=0, padx=20, pady=25)

        allBtn = tk.Button(optFrame, command=self.showAll, text="Show All", width=10, font=("Arial", 20, "bold"),
                           bg="gray")
        allBtn.grid(row=1, column=0, padx=20, pady=25)

        quantBtn = tk.Button(optFrame, command=self.addQuant, text="Add Quantity", width=10, font=("Arial", 20, "bold"),
                             bg="gray")
        quantBtn.grid(row=2, column=0, padx=20, pady=25)

        purBtn = tk.Button(optFrame, command=self.billFun, text="Purchase", width=10, font=("Arial", 20, "bold"),
                           bg="gray")
    ...
    def tabFun(self):
        ...
        self.table = ttk.Treeview(tabFrame, columns=("name", "price", "quant", "exp"), xscrollcommand=x_scrol.set,
    ...
    def searchFun(self):
        ...
        lbl = tk.Label(self.srchFrame, text="Medicine: ", bg=self.clr(140, 100, 200), fg="light green",
                       font=("Arial", 15, "bold"))
        ...
        okBtn = tk.Button(self.srchFrame, command=self.searchMed, text="OK", bg="cyan", font=("Arial", 20, "bold"),
                          width=20)
    ...
    def addQuant(self):
        ...
        lbl = tk.Label(self.addQauntFrame, text="Medicine: ", bg=self.clr(140, 100, 200), fg="light green",
                       font=("Arial", 15, "bold"))
        ...
        lbl2 = tk.Label(self.addQauntFrame, text="Quantity: ", bg=self.clr(140, 100, 200), fg="light green",
                        font=("Arial", 15, "bold"))
        ...
        okBtn = tk.Button(self.addQauntFrame, command=self.insertQuant, text="OK", bg="cyan",
                          font=("Arial", 20, "bold"), width=20)
    ...
    def purchaseFun(self):
        ...
        lbl = tk.Label(self.purFrame, text="Medicine: ", bg=self.clr(140, 100, 200), fg="light green",
                       font=("Arial", 15, "bold"))
        lbl.grid(row=0, column=0, padx=20, pady=20)
        self.medicineIn = tk.Entry(self.purFrame, width=20, font=("Arial", 15), bd=2)
        self.medicineIn.grid(row=0, column=1, padx=10, pady=20)

        lbl2 = tk.Label(self.purFrame, text="Quantity: ", bg=self.clr(140, 100, 200), fg="light green",
                        font=("Arial", 15, "bold"))
        lbl2.grid(row=1, column=0, padx=20, pady=20)
        self.quantityIn = tk.Entry(self.purFrame, width=20, font=("Arial", 15), bd=2)
        self.quantityIn.grid(row=1, column=1, padx=10, pady=20)

        okBtn = tk.Button(self.purFrame, command=self.innerPur, text="OK", bg="cyan", font=("Arial", 20, "bold"),
                          width=20)
        okBtn.grid(row=2, column=0, padx=30, pady=40, columnspan=2)
    ...
    def billFun(self):
        ...
        pButton = tk.Button(self.billFrame, command=self.purchaseFun, text="Purchase", bd=2, relief="raised", width=8,
                            font=("Arial", 20, "bold"), bg="cyan")
        pButton.place(x=30, y=400)

        billButton = tk.Button(self.billFrame, command=self.totalBill, text="Print Bill", bd=2, relief="raised",
                               width=8, font=("Arial", 20, "bold"), bg="cyan")
        billButton.place(x=230, y=400)

        exitButton = tk.Button(self.billFrame, command=self.exitFun, text="Exit", bd=2, relief="raised", width=8,
                               font=("Arial", 20, "bold"), bg="cyan")
